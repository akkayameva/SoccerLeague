/*
 * *
 *  * Created by Sheeraz A. Memon on 9/20/19 10:36 AM
 *  * Copyright (c) 2019 . All rights reserved.
 *  * Last modified 8/29/19 6:40 PM
 *
 */
...
open class Event<out T>(private val content: T) {
    ...
    private val consumedBy = hashMapOf<String, Boolean>()
    ...
    fun consume(tag: String): T? {
        return if (consumedBy.containsKey(tag) && consumedBy[tag] == true) {
            null
        } else {
            consumedBy[tag] = true
            content
